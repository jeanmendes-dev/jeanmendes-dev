...
# Esta função cria AVISITN a partir de VISITNUM onde disponível,
# ou a partir de ordenação temporal por ADT/ASTDT como fallback.
normalise_visit_key <- function(df, dataset_name) {
  ...
  # Caso 2: VISITNUM disponível — promover para AVISITN
  ...
  # Caso 3: sem VISITNUM — criar sequência temporal por data
...
# e microbiologia. adsl garante cobertura dos 12 sujeitos.
build_spine <- function(datasets) {
  ...
  # Garantir cobertura total — adsl tem os 12 sujeitos do estudo
